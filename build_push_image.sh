...
# ImageName=$(prompt_input "Image Name" "$ImageName")
# ImageTag=$(prompt_input "Image Tag" "$ImageTag")
# dockerfilePath=$(prompt_input "Dockerfile Path" "$dockerfilePath")
# registry=$(prompt_input "Registry" "$registry")
